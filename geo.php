...
//if ($dbobj = connectme('50.62.209.120', 'jyotirmay', 'Shaan@123.', 'jyotirmay_appdata')) {
	$x = mysqli_query($jdb,"INSERT INTO user_location (userid, latitude, longitude, street, town, country, postcode, fulladdress, timecreated)
VALUES (".$userlocation->userid.",".$userlocation->latitude.",".$userlocation->longitude.",'".$userlocation->street."',
		 '".$userlocation->town."','".$userlocation->country."',".$userlocation->postcode.",'".$userlocation->fulladdress."', ".time().")");
	if($x) {
